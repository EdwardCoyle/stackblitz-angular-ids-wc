...
let IdsTimePickerModule = class IdsTimePickerModule {
};
IdsTimePickerModule = __decorate([
    NgModule({
        declarations: [
...
export { IdsTimePickerModule };
//# sourceMappingURL=ids-time-picker.module.js.map