...
let IdsMenuButtonModule = class IdsMenuButtonModule {
};
IdsMenuButtonModule = __decorate([
    NgModule({
        declarations: [
...
export { IdsMenuButtonModule };
//# sourceMappingURL=ids-menu-button.module.js.map