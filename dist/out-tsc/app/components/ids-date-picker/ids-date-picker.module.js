...
let IdsDatePickerModule = class IdsDatePickerModule {
};
IdsDatePickerModule = __decorate([
    NgModule({
        declarations: [
...
export { IdsDatePickerModule };
//# sourceMappingURL=ids-date-picker.module.js.map