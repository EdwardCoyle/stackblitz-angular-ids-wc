...
let IdsModalRoutingModule = class IdsModalRoutingModule {
};
IdsModalRoutingModule = __decorate([
    NgModule({
        imports: [RouterModule.forChild(routes)],
        exports: [RouterModule]
    })
], IdsModalRoutingModule);
export { IdsModalRoutingModule };
//# sourceMappingURL=ids-modal-routing.module.js.map