...
let IdsCardRoutingModule = class IdsCardRoutingModule {
};
IdsCardRoutingModule = __decorate([
    NgModule({
        imports: [RouterModule.forChild(routes)],
        exports: [RouterModule]
    })
], IdsCardRoutingModule);
export { IdsCardRoutingModule };
//# sourceMappingURL=ids-card-routing.module.js.map