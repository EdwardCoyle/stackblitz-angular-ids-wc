...
let LocalizedDatesComponent = class LocalizedDatesComponent {
    constructor() { }
    ngOnInit() {
...
], LocalizedDatesComponent.prototype, "pageContainer", void 0);
__decorate([
    ViewChild('maskDateShort', { read: ElementRef })
], LocalizedDatesComponent.prototype, "maskDateShort", void 0);
__decorate([
    ViewChild('maskDateTime', { read: ElementRef })
], LocalizedDatesComponent.prototype, "maskDateTime", void 0);
LocalizedDatesComponent = __decorate([
    Component({
...
export { LocalizedDatesComponent };
//# sourceMappingURL=localized-dates.component.js.map