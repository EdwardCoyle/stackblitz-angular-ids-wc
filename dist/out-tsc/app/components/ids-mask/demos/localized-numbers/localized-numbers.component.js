...
let LocalizedNumbersComponent = class LocalizedNumbersComponent {
    constructor() {
...
__decorate([
    ViewChildren('idsInput', { read: ElementRef })
], LocalizedNumbersComponent.prototype, "idsInput", void 0);
__decorate([
    ViewChild('pageContainer', { read: ElementRef })
], LocalizedNumbersComponent.prototype, "pageContainer", void 0);
LocalizedNumbersComponent = __decorate([
    Component({
...
export { LocalizedNumbersComponent };
//# sourceMappingURL=localized-numbers.component.js.map